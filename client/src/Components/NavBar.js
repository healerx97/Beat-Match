            ...
            <Navbar className="navbar"  variant="primary" sticky = "top" style={{minWidth: '100vw', minHeight: '10vh'}}>
                ...
                <Navbar.Brand>
                    ...
                    <Nav className="me-auto">
                        <Nav.Link className="nlink" onClick={handleNavLinkClick} as={Link} to="/">
                        Swipe
                        </Nav.Link>
                        <Nav.Link className="nlink" onClick={handleNavLinkClick} as={Link} to="/matches">
                        Matches
                        </Nav.Link>
                        <Nav.Link className="nlink" onClick={handleNavLinkClick} as={Link} to="/profile">
                        Profile
                        </Nav.Link>
                        <Nav.Link className="nlink" onClick={handleNavLinkClick} as={Link} to="/feed">
                        Feed
                        </Nav.Link>
                        <Nav.Link className="nlink" as={Link} onClick = {handleLogout} to="/login" >
                        {user ? "Logout" : "Login"}
                        </Nav.Link>
                    </Nav>
                </Container>
